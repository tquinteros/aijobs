...
import { JOB_DETAILS_QUERY_KEY, USER_APPLICATION_QUERY_KEY } from "@/lib/company"
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {statusConfig && (
            <span
              className={`text-xs font-semibold px-2.5 py-1 rounded-full border ${statusConfig.className}`}
            >
              {statusConfig.label}
            </span>
          )}
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">
                {alreadyApplied ? "Tu postulación" : "Postularse"}
              </CardTitle>
            </CardHeader>
